    ...
    >
      <span
        className={cn(
          ...
          variant === "dark"
            ? "text-white border-gold-warm/50 group-hover:border-solid group-hover:border-gold-warm group-focus-visible:border-solid group-focus-visible:border-gold-warm"
            : "text-gray-900 border-gray-400 group-hover:border-solid group-hover:border-black group-focus-visible:border-solid group-focus-visible:border-black"
        )}
      >
        {term}
      </span>
        ...
        {isVisible && (
          <motion.span
            ...
            className={cn(
              ...
              variant === "dark" ? "bg-white/5 border-white/10" : "bg-gray-900/95 border-gray-800"
            )}
          >
            <span className="flex items-start gap-2">
              <span className="w-1 h-full bg-gold-warm absolute left-0 top-0 bottom-0 rounded-l-sm" />
              <span className="pl-2 block">
                <span className="block font-mono text-[10px] text-gold-warm tracking-widest mb-1 uppercase">
                  Term Definition
                </span>
                <span
                  className={cn(
