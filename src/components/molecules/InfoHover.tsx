      ...
      <AnimatePresence>
        {isHovered && (
          <motion.div
            ...
            className={cn(
              "absolute left-1/2 -translate-x-1/2 bottom-full mb-3 w-64 p-4 backdrop-blur-xl border rounded-sm shadow-2xl z-50 pointer-events-none text-left",
              variant === "dark" 
          ...
          >
            <div className="flex items-start gap-2">
              <div className="w-1 h-full bg-valo-gold absolute left-0 top-0 bottom-0 rounded-l-sm" />
              <div className="pl-2">
