...
export default function LabClient() {
  ...
  const handleExportJSON = () => {
    const dataStr = "data:text/json;charset=utf-8," + encodeURIComponent(JSON.stringify(labConfig, null, 2));
              ...
              <div className="mt-12 p-6 border border-dashed border-white/10 rounded-sm text-center">
                 ...
                 <div className="flex gap-2 justify-center">
                   ...
                   <button 
                     ...
                     className="px-4 py-2 bg-white/5 hover:bg-white/10 text-white font-mono text-xs tracking-widest border border-white/10 rounded transition-colors flex items-center gap-2"
                   >
                     <Download className="w-3 h-3" />
                     JSON
                   </button>
