...
export default function CollectiveError({
  error,
  reset,
}: {
  ...
  return (
    <div className="flex min-h-screen bg-paper text-black items-center justify-center">
      <div className="text-center max-w-md px-8">
        <h1 className="font-serif text-5xl mb-6">Community Unavailable</h1>
        <p className="font-sans text-sm text-gray-500 tracking-widest uppercase mb-8">
          We couldn&apos;t load the community gallery. Please try again.
        </p>
        <button
          onClick={reset}
